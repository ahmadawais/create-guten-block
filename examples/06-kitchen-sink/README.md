...
> This project was bootstrapped with [Create Guten Block](https://github.com/ahmadawais/create-guten-block)# 🔰 EXAMPLE: Basic Single Block
...
This example includes a WordPress Gutenberg plugin called `kitchen-sink` which creates a Gutenberg block also called `kitchen-sink`.
...
- Run `create-guten-block kitchen-sink` command.
