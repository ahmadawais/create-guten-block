 ...
 *
 * Block: `05-editable-with-controls-esnext` — Webpack config file.
 *
 * Working of a Webpack can be very simple or complex. This is an intenally simple
 * build configuration.
 *
 * Webpack basics — If you are new to the Webpack here's all you need to know:
 ...
 *     1. In the command line browse the folder `05-editable-with-controls-esnext` where
